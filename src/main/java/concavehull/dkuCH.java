...
/**
 * **********************************************************************************
 * dkuCH * - Options	: -p using original data file -f using existing convex list
 * file
 *
 * - Input : (1) dataset (2) Convex hull points List
 *
 * - Output : (1) dataset (if row is included in vetexes of concave hull, change
 * the flag colum to 1 ) (2) Concave hull points List
 *
 * - default setting (1) NO_OF_DIM	:	dimension of dataset, number of features
