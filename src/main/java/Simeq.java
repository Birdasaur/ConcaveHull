// simeq.java  solve simultaneous equations AX=Y 
	...
	// Ref : http://www.cs.umbc.edu/~squire/download/simeq.java
...
public class Simeq
{
  public void Simeqation(final double A[][], final double Y[], double X[])
  {
    int n=A.length;
 ...
 /* public void Simeq(int n, final double A[][], final double Y[], double X[])
  ...
  public void Simeq(int n, final double B[][], double X[])
  {
    solve(n, B, X);
  }
*/
